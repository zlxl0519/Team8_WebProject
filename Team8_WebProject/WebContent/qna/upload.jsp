<%@page import="dao.QnaFileDao"%>
<%@page import="dto.QnaFileDto"%>
            ...
            for (FileItem item : formItems) {
                ...
                if (!item.isFormField()) {//만일 파일 필드라면...
                   ...
                   if(item.getFieldName().equals("title")){
                      ...
                      dto.setFile_Title(title);
                      
                      //여기에...insert에 넣었어야 하는 내용들 넣어야 한다...
                   }
                
                }//if
            }//for
            //DB 에 파일 정보를 저장한다.
            isSuccess=QnaFileDao.getInstance().insert(dto);
        }//if
...
<div class="container">
   <%if(isSuccess){ %>
      <p>파일을 업로드했습니다. <a href="../list.jsp">확인</a></p>
   <%}else{ %>
      <p>파일 업로드 실패! <a href="upload_form.jsp">다시시도</a></p>
   <%} %>
